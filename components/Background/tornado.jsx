...
const Tornado = ({baseColor1, baseColor2, baseColor3, baseColor4}) => {
    const fill1 = baseColor1 || "#20ADEE";
    const fill2 = baseColor2 || "#3E0CFF";
    const fill3 = baseColor3 || "#2f5df7";
    const fill4 = baseColor4 || "#20ADEE";
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
      <rect fill={fill1} width="2000" height="1500" />
      <defs>
        ...
        <linearGradient
          ...
          y2="750"
        >
          <stop offset="0" stopColor={fill3} />
          <stop offset="1" stopColor={fill4} />
        </linearGradient>
        <path
          id="s"
          fill="url(#b)"
